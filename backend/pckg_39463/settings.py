"""
Django settings for pckg_39463 project.
...
WSGI_APPLICATION = 'pckg_39463.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "pckg_39463 API",
    "DESCRIPTION": "API documentation for pckg_39463 App",
    "VERSION": "v1",
}
